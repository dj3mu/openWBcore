import{_ as w,C as B}from"./index-f58a90d6.js";import{_ as T}from"./dynamic-import-helper-be004503.js";import{_ as c,p as s,k as u,l as b,A as o,L as l,u as a,x as D,q as r,y as k,a0 as W,a1 as $,z as d}from"./vendor-20bb207d.js";import"./vendor-fortawesome-63a0ad05.js";import"./vendor-bootstrap-d275de6c.js";import"./vendor-jquery-89b63fca.js";import"./vendor-axios-13ef03ae.js";import"./vendor-sortablejs-ad1d2cc8.js";const S={name:"DisplayThemeFallback",emits:["update:configuration"],props:{configuration:{type:Object,required:!0},displayThemeType:{type:String}},methods:{updateConfiguration(t,n=void 0){this.$emit("update:configuration",{value:t,object:n})}}},q={key:0,class:"display-theme-fallback"};function V(t,n,i,x,g,f){const p=s("openwb-base-alert"),v=s("openwb-base-textarea");return Object.keys(i.configuration).length>0?(u(),b("div",q,[o(p,{subtype:"warning"},{default:l(()=>[a(' Es wurde keine Konfigurationsseite für das Display Theme "'+D(i.displayThemeType)+'" gefunden. Die Einstellungen können als JSON direkt bearbeitet werden. ',1)]),_:1}),o(v,{title:"Konfiguration",subtype:"json","model-value":i.configuration,"onUpdate:modelValue":n[0]||(n[0]=m=>f.updateConfiguration(m,"configuration"))},{help:l(()=>[a(" Bitte prüfen Sie, ob die Eingaben richtig interpretiert werden. ")]),_:1},8,["model-value"]),o(p,{subtype:"info"},{default:l(()=>[r("pre",null,D(JSON.stringify(i.configuration,void 0,2)),1)]),_:1})])):(u(),k(p,{key:1,subtype:"info"},{default:l(()=>[a(' Das Display Theme "'+D(i.displayThemeType)+'" kann nicht angepasst werden. ',1)]),_:1}))}const A=c(S,[["render",V],["__file","/opt/openWB-dev/openwb-ui-settings/src/components/display_themes/OpenwbDisplayThemeFallback.vue"]]),C={name:"OpenwbDisplayThemeProxy",emits:["update:configuration"],props:{displayThemeType:{type:String,required:!0},configuration:{type:Object,required:!0}},computed:{myComponent(){return console.debug(`loading display theme: ${this.displayThemeType}`),W({loader:()=>T(Object.assign({"./cards/displayTheme.vue":()=>w(()=>import("./displayTheme-35595a93.js"),["assets/displayTheme-35595a93.js","assets/vendor-20bb207d.js","assets/vendor-sortablejs-ad1d2cc8.js","assets/vendor-7b9e30aa.css"])}),`./${this.displayThemeType}/displayTheme.vue`),errorComponent:A})}},methods:{updateConfiguration(t){this.$emit("update:configuration",t)}}};function z(t,n,i,x,g,f){return u(),k($(f.myComponent),{configuration:i.configuration,displayThemeType:i.displayThemeType,"onUpdate:configuration":n[0]||(n[0]=p=>f.updateConfiguration(p))},null,40,["configuration","displayThemeType"])}const O=c(C,[["render",z],["__file","/opt/openWB-dev/openwb-ui-settings/src/components/display_themes/OpenwbDisplayThemeProxy.vue"]]),I={name:"OpenwbOptionalComponents",mixins:[B],components:{OpenwbDisplayThemeProxy:O},data(){return{mqttTopicsToSubscribe:["openWB/general/extern","openWB/optional/rfid/active","openWB/optional/led/active","ToDo/optional/led/instant_blocked","ToDo/optional/led/pv_blocked","ToDo/optional/led/scheduled_blocked","ToDo/optional/led/standby_blocked","ToDo/optional/led/stop_blocked","ToDo/optional/led/instant","ToDo/optional/led/pv","ToDo/optional/led/scheduled","ToDo/optional/led/standby","ToDo/optional/led/stop","openWB/optional/int_display/active","openWB/optional/int_display/standby","openWB/optional/int_display/rotation","openWB/optional/int_display/on_if_plugged_in","openWB/optional/int_display/pin_active","openWB/optional/int_display/pin_code","openWB/optional/int_display/theme","openWB/system/configurable/display_themes","openWB/optional/et/active","openWB/optional/et/config/provider","openWB/optional/et/config/max_price"]}},computed:{displayThemeList:{get(){return this.$store.state.mqtt["openWB/system/configurable/display_themes"]}}},methods:{getDisplayThemeDefaultConfiguration(t){const n=this.displayThemeList.find(i=>i.value==t);return Object.prototype.hasOwnProperty.call(n,"defaults")?{...n.defaults.configuration}:(console.warn("no default configuration found for display theme type!",t),{})},updateSelectedDisplayTheme(t){this.updateState("openWB/optional/int_display/theme",t,"type"),this.updateState("openWB/optional/int_display/theme",this.getDisplayThemeDefaultConfiguration(t),"configuration")},updateConfiguration(t,n){console.debug("updateConfiguration",t,n),this.updateState(t,n.value,n.object)}}},N={class:"optionalComponents"},F={name:"optionalComponentsForm"},P={key:0},R=r("br",null,null,-1),M=r("br",null,null,-1),j=["innerHTML"],U={key:0},H=r("br",null,null,-1),J=r("hr",null,null,-1),Z={key:1},K={key:2},G=r("hr",null,null,-1),Q={key:0};function X(t,n,i,x,g,f){const p=s("openwb-base-button-group-input"),v=s("openwb-base-alert"),m=s("openwb-base-card"),_=s("openwb-base-heading"),y=s("openwb-base-range-input"),L=s("openwb-base-select-input"),h=s("openwb-display-theme-proxy"),E=s("openwb-base-submit-buttons");return u(),b("div",N,[r("form",F,[o(m,{title:"RFID"},{default:l(()=>[o(p,{title:"RFID aktivieren","model-value":t.$store.state.mqtt["openWB/optional/rfid/active"],"onUpdate:modelValue":n[0]||(n[0]=e=>t.updateState("openWB/optional/rfid/active",e)),buttons:[{buttonValue:!1,text:"Aus",class:"btn-outline-danger"},{buttonValue:!0,text:"An",class:"btn-outline-success"}]},{help:l(()=>[a(" Dies bedingt das Vorhandensein eines RFID-Readers in deiner openWB. Bitte prüfe zuerst die Hardwareausstattung deiner openWB (z.B. Lieferschein). ")]),_:1},8,["model-value"]),t.$store.state.mqtt["openWB/optional/rfid/active"]===!0?(u(),b("div",P,[o(v,{subtype:"info"},{default:l(()=>[a(" Die RFID-Tags, die an dem jeweiligen Ladepunkt gültig sind, müssen in der Ladepunkt-Vorlage hinterlegt werden. Der RFID-Tag muss in den Einstellungen des Fahrzeugs diesem zugeordnet werden."),R,a(" Es kann zuerst angesteckt und dann der RFID-Tag gescannt werden oder zuerst der RFID-Tag gescannt werden. Dann muss innerhalb von 5 Minuten ein Auto angesteckt werden, sonst wird der RFID-Tag verworfen. Das Auto wird erst nach dem Anstecken zugeordnet."),M,r("span",{innerHTML:t.$store.state.text.rfidWiki},null,8,j)]),_:1})])):d("v-if",!0)]),_:1}),d(` <openwb-base-card title="LED-Ausgänge">
				...
				>
					...
					</div> `),G,t.$store.state.mqtt["openWB/optional/int_display/theme"]!==void 0?(u(),b("div",Q,[o(L,{class:"mb-2",title:"Theme des Displays",options:f.displayThemeList,"model-value":t.$store.state.mqtt["openWB/optional/int_display/theme"].type,"onUpdate:modelValue":n[4]||(n[4]=e=>f.updateSelectedDisplayTheme(e))},{help:l(()=>[a(" Hier können unterschiedliche Display-Anzeigen, s.g. Themes, ausgewählt werden. Die Anzahl der Themes wird sich mit zukünftigen Releases erhöhen. ")]),_:1},8,["options","model-value"]),t.$store.state.mqtt["openWB/optional/int_display/theme"].type?(u(),k(h,{key:0,displayThemeType:t.$store.state.mqtt["openWB/optional/int_display/theme"].type,configuration:t.$store.state.mqtt["openWB/optional/int_display/theme"].configuration,"onUpdate:configuration":n[5]||(n[5]=e=>f.updateConfiguration("openWB/optional/int_display/theme",e))},null,8,["displayThemeType","configuration"])):d("v-if",!0)])):d("v-if",!0)]))]),_:1}),d(` <openwb-base-card title="Variable Stromtarife">
			...
			</openwb-base-card> `),o(E,{formName:"optionalComponentsForm",onSave:n[6]||(n[6]=e=>t.$emit("save")),onReset:n[7]||(n[7]=e=>t.$emit("reset")),onDefaults:n[8]||(n[8]=e=>t.$emit("defaults"))})])])}const st=c(I,[["render",X],["__file","/opt/openWB-dev/openwb-ui-settings/src/views/OptionalComponents.vue"]]);export{st as default};
